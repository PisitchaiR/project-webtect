    ...
    <div class="hidden h-screen w-full flex items-center border border-dark absolute top-0 z-50" id="slidbar" style="background-color: rgba(0, 0, 0,0.3)">
        <div class="border-l border-black bg-white h-screen absolute right-0 top-0 w-8/12 flex">
            <div class="border-r border-black w-2/6 h-full">
                ...
                <div class="overflow-y-scroll h-full hide-scroll-bar">
        ...
        <div class="mx-10 flex flex-col items-center justify-between">
            <div class="w-full flex justify-between">
                ...
                <div class="grid grid-cols-3 gap-2 gap-x-10 text-xs">
                    <a class="py-1" href="javascript:void(0)">about us
                    </a>
                    <a class="py-1" href="javascript:void(0)">privacy policy
                    </a>
                    <a class="py-1" href="javascript:void(0)">how
                        to order
                    </a>
                    <a class="py-1" href="javascript:void(0)">faq
                    </a>
                    <a class="py-1" href="javascript:void(0)">delivery policy
                    </a>
                    <a class="py-1" href="javascript:void(0)">tack your order
                    </a>
                    <a class="py-1" href="javascript:void(0)">contact us
                    </a>
                    <a class="py-1" href="javascript:void(0)">terms of use
                    </a>
                    <a class="py-1" href="javascript:void(0)">return & exchanges
                    </a>
                </div>
